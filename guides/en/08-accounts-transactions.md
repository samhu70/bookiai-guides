...
hero_image: "" # optional; place the main account-transactions screenshot here (e.g., ../assets/accounts_transactions/hero.png)
status: "draft"
---
...
## 5. Next steps
- Ready to create new entries? Return to [Ledger Journal Entries](./05-ledger-journal-entries.md).
